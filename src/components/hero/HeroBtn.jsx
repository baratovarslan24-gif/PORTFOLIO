  ...
  return (
    <div className="flex justify-center">
      <button>
        <a
          href="#about"
          className="flex flex-col gap-2.5 items-center font-semibold text-sm text-white md:text-lg
       focus:border-2 focus:border-white focus:rounded-[3px] hover:underline active:opacity-70 active:border-none active:no-underline"
        >
          дивитися роботи
          <span className="mb-3.75 md:mb-7.5 focus:inherit active:inherit">
            <svg
              width="37"
              height="22"
              viewBox="0 0 37 22"
